...
namespace PlayZone.Data.Migrations
{
    ...
    [Migration("20200328203442_AddColoumToHistoryAndFavorites")]
    partial class AddColoumToHistoryAndFavorites
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayZone.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("PlayZone.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("PlayZone.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PlayZone.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PlayZone.Data.Models.Video", b =>
                {
                    b.HasOne("PlayZone.Data.Models.Category", "Category")
                        .WithMany("Videos")
